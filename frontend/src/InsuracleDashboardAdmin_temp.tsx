...
import { PARAMIFY_ABI, MOCK_ORACLE_ABI, getContractAddresses } from './lib/contract';
...
export default function InsuracleDashboardAdmin({ setUserType }: ParamifyDashboardProps) {
  ...
  const handleFundContract = async () => {
    ...
    try {
      ...
      const code = await provider.getCode(contractAddresses.paramify);
      if (code === '0x') {
