...
class DockerRpcServer {
    ...
    async listen(nodeArgs = [], adapterArgs = [], blockProcess = true) {
        ...
        const nodeImageTag = await (0, utils_1.getLatestImageName)(NODE_CONTAINER_NAME);
        const adapterImageTag = await (0, utils_1.getLatestImageName)(ADAPTER_CONTAINER_NAME);
