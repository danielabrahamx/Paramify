...
import { idlFactory } from './paramify_core.did.js';
export { idlFactory } from './paramify_core.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PARAMIFY_CORE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./paramify_core.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the paramify_core canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./paramify_core.did.js")._SERVICE>}
 */
export const paramify_core = createActor(canisterId);
