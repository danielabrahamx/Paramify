...
import { idlFactory } from './paramify_oracle.did.js';
export { idlFactory } from './paramify_oracle.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PARAMIFY_ORACLE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./paramify_oracle.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the paramify_oracle canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./paramify_oracle.did.js")._SERVICE>}
 */
export const paramify_oracle = createActor(canisterId);
